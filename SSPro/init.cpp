...
void CSSProDlg::init()
{
	...
	m_slider_s_min.SetRange(0, 255); m_slider_h_min.SetPos(S_min);
	m_slider_s_max.SetRange(0, 255); m_slider_h_max.SetPos(S_max);
	m_slider_v_min.SetRange(0, 255); m_slider_h_min.SetPos(V_min);
	m_slider_v_max.SetRange(0, 255); m_slider_h_max.SetPos(V_max);
